      ...
      <section className="relative px-4 pb-20 max-w-7xl mx-auto z-10">
          ...
          {aiRoboticsData.map((card) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute -inset-0.5 rounded-2xl blur 
                ...
                <div className="relative mt-6 pt-5 border-t border-neutral-800">
                  <button className="w-full flex items-center justify-between text-sm font-bold
        ...
        <div className="mt-10 flex justify-center">
          <button className="group relative overflow-hidden rounded-full">
            ...
            <div className="relative flex items-center gap-2 px-8 py-3.5 text-sm font-bold text-white">
              Partner With Us
              <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
            </div>
          </button>
