      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative inline-block">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-blue-600 font-medium hover:from-purple-500 blur-2xl opacity-40 rounded-full" />
            <motion.button
              onClick={() => navigate("/contact")}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="relative px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 font-medium hover:from-purple-500 rounded-full text-white font-semibold text-lg flex items-center gap-2 mx-auto shadow-lg hover:shadow-purple-500/50 transition-shadow duration-300"
            >
              Get Started Today
