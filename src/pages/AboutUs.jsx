  ...
  return (
    ...
    opacity-50"
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24">
        {/* Page Header */}
        <h1 className="text-5xl sm:text-6xl font-bold mb-8">About Us</h1>

        {/* Overview Section */}
        <section className="mb-16">
          <h2 className="text-3xl sm:text-4xl font-semibold mb-4">Overview</h2>
          <p className="text-justify  text-gray-800 leading-relaxed mb-4 text-xl ">
            ...
            dolor sit amet consectetur adipisicing elit. Voluptates atque
            reiciendis delectus nemo corrupti nisi eum, nostrum ad aliquid, rem
            nesciunt, ex iste explicabo! Quasi itaque nostrum praesentium fuga
            consequatur!.
          </p>
        </section>
        ...
        <section className="mb-16">
          <h2 className="text-3xl sm:text-4xl font-semibold mb-4">Mission</h2>
        ...
        <section>
          ...
          <p className="text-gray-800 leading-relaxed mb-4 text-xl">
            ...
            sed semper lorem. Pellentesque habitant morbi tristique senectus et
            netus et malesuada fames ac turpis egestas. Fusce ut placerat orci
            nulla pellentesque dignissim enim sit amet. Amet purus gravida quis
