              ...
              <div className="relative bg-black/60 backdrop-blur-xl border border-white/10 rounded-xl p-6 hover:border-white/20 transition-all duration-300">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-6 py-2.5 bg-gradient-to-r from-purple-400 via-blue-400 to-pink-400 rounded-full text-white font-semibold text-sm"
                  >
                    Apply Now
                  </motion.button>
                </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full px-6 py-3.5 bg-gradient-to-r from-purple-400 via-blue-400 to-pink-400 rounded-xl text-white font-semibold text-lg"
                >
                  Submit Application
                </motion.button>
              </form>
