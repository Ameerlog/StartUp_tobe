...
const templates = [
  { title: "Landing Page", desc: "Lorem ipsum dolor sit amet consectetur adipiscing elit.", icon: <Globe size={24} /> },
  { title: "Dashboard", desc: "Ut enim ad minim veniam quis nostrud exercitation.", icon: <Layout size={24} /> },
  { title: "Blog Template", desc: "Duis aute irure dolor in reprehenderit voluptate.", icon: <PenTool size={24} /> },
  { title: "E-Commerce", desc: "Excepteur sint occaecat cupidatat non proident.", icon: <Rocket size={24} /> },
];

const hallOfFame = [
  { title: "Best Design", desc: "Lorem ipsum dolor sit amet consectetur.", icon: <Trophy size={24} /> },
  { title: "Most Popular", desc: "Ut enim ad minim veniam quis nostrud.", icon: <Star size={24} /> },
  { title: "Top Rated", desc: "Duis aute irure dolor in reprehenderit.", icon: <Medal size={24} /> },
];
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900 mb-6">Popular Templates</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900 mb-6">Hall of Fame</h2>
