...
const InvestorCard = ({ card }) => (
  <div className="shrink-0 w-60 sm:w-70 md:w-[320px] lg:w-85 px-3">
    <div className="group h-65 rounded-2xl border border-white/20 bg-gray-900/50 p-5 backdrop-blur-sm transition hover:bg-gray-900/70 hover:border-white">
      <div className="h-40 flex items-center justify-center bg-white/10 rounded-xl border border-white/20">
        <img
          src={card.src}
          alt={card.company}
          className="max-h-30 object-contain grayscale group-hover:grayscale-0 transition"
        />
      </div>

      <div className="text-center mt-4">
        <h3 className="font-bold text-gray-400 group-hover:text-white transition">
          {card.company}
        </h3>
  ...
  return (
    <div className="bg-black text-white overflow-hidden">
      ...
      <section className="relative pt-36 pb-28 text-center">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-neutral-400 text-lg">
            Investors, founders, and visionaries collaborating to build the future.
          </p>

         
          <button
            onClick={() => navigate("/coworker-form")}
            className="mt-10 px-8 py-3 rounded-full font-semibold text-white
      ...
      <section className="relative py-16">
        ...
        <MarqueeRow data={investorCards} speed={25} renderItem={(card) => <InvestorCard card={card} />} />
      </section>
