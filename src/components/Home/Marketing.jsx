                    ...
                    <div className="p-4 flex flex-col flex-1">
                      ...
                      <div className="mt-auto">
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-2 rounded-lg bg-white text-black py-2.5 text-xs font-bold uppercase tracking-wider transition-transform active:scale-[0.98] hover:bg-gray-200"
                        >
                          Book a CoBrother
