...
export default function ComplianceCards({ variant = "dark" }) {
  ...
  return (
    <section
      className={`w-full pt-8 pb-16 relative overflow-hidden ${theme.section}`}
    >
      <h2
        className={`text-center text-2xl sm:text-3xl md:text-4xl lg:text-[42px] font-bold ${theme.heading}`}
      >
        Compliance Services
      </h2>
          ...
          {duplicatedServices.map((service, index) => {
            ...
            return (
              <div
                ...
                className="shrink-0 w-[380px] px-5"
              >
                <div
